...
print(f"A percentagem de votos nulos sobre o total de votos: {round(((nulo*100) / TotalVotos),2)}")
print(f"A percentagem de votos em branco sobre o total de votos: {round(((branco*100) / TotalVotos),2)}")